...
interface IERC20 {
    function totalySupply() external view returns (uint256);
...
contract PickleVoteProxy {
    //ETH/Pickle token
    IERC20 public constant votes =
        IERC20(0xdc98556Ce24f007A5eF6dC1CE96322d65832A819);

    // Pickle's masterchef contract
    MasterChef public constant chef =
        MasterCher(0xbD17B1ce622d73bD438b9E658acA5996dc394b0d);
